...
const AboutSection = ({ isInner }: IAboutSection) => {
  const about = {
    topDescription:
      "We are a tight-knit group of young, tech-savvy marketing experts, constantly pushing the boundaries of branding and redefining what it means to connect brands with their target audiences.",
    // lowDescription:
